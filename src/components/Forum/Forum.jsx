...
function Forum() {
    ...
    const { getDiscussions, createDiscussion } = ForumService();
    ...
    const saveDiscussion = async (discussion) => {
        await createDiscussion(discussion);
        loadDiscussions(1);
    }
    return (
        <Container className="text-start" color="#404E5C" style={{
            fontFamily: 'Inter'
        }}>
            ...
            <div style={{
            ...
            }} className="mb-3" onClick={() => setModalShow(true)}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                </svg> Започни нова дискусија</div>
            <DiscussionModal show={modalShow} onHide={() => setModalShow(false)} onAdd={saveDiscussion} />
